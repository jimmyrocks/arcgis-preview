...
`,$=new Map,ce=(e,t)=>{G(()=>{if(!e||typeof document>`u`)return;let n=document,r=$.get(n);if(r){t&&r.setAttribute(`nonce`,t);return}let i=n.createElement(`style`);i.textContent=e,t&&i.setAttribute(`nonce`,t),n.head.appendChild(i),$.set(n,i)},[t])};function le(e){return ce(se,e.nonce),n.createElement(oe,{...e})}export{B as n,le as t};