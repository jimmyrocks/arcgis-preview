...
- “Recenter on selected” (🎯) MapLibre control that enables only when a feature is selected.
...
- Basemap tile source no longer passes undefined tile options (fixes error reading `length`).
